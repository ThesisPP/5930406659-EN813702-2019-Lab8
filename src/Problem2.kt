...
fun getFortune(birthday: Int) : String {
    var fortuneList = listOf("Wish you are happy today :D", "You will have a great day!",
        "Things well go well for you today.", "Today is a good day of exercising restraint",
